  ...
  <div class="row pb-10">
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
      <div class="card-box height-100-p widget-style3">
        <div class="d-flex flex-wrap">
          <div class="widget-data">
            <div class="weight-700 font-24 text-dark">{{ $data->where('paket_id', '=', '2')->count('paket_id') }}</div>
            <div class="font-14 text-secondary weight-500">
              Total Booking
            </div>
          </div>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
      <div class="card-box height-100-p widget-style3">
        <div class="d-flex flex-wrap">
          <div class="widget-data">
            <div class="weight-700 font-24 text-dark">{{ $data->where('paket_id', '=', '1')->count('paket_id') }}</div>
            <div class="font-14 text-secondary weight-500">
              Total Reguler
            </div>
          </div>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
      <div class="card-box height-100-p widget-style3">
        <div class="d-flex flex-wrap">
          <div class="widget-data">
            <div class="weight-700 font-24 text-dark">{{ $data->sum('total') + $data->sum('down_payment') + $data->sum('additional_cost') }}</div>
            <div class="font-14 text-secondary weight-500">
              Total Pemasukan
            </div>
          </div>
